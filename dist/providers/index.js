...
var GlobalStyle = (0, _styledComponents.createGlobalStyle)(_templateObject || (_templateObject = _taggedTemplateLiteral(["", ""])), toastCss);
...
var ToastProvider = (_ref) => {
  ...
  (0, _helpers.throwOnNoTransport)(transport);
  ...
  (0, _hooks.useListenForTransportEvent)(transport, clientKey, handleToast);
